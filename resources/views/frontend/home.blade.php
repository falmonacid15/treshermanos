                        ...
                        <div class="row no-gutters">
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 align-self-sm-center">
                                <div class="gallery__item gallery__item--text">
                                    ...
                                    <a class="gallery-more-link" href="{{ route('frontend.products.all') }}">Ver todos</a>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <p>
                                <a class="custom-btn primary big" href="{{ route('frontend.information.all') }}">Ver mas</a>
                            </p>
                        </div>
                    </div>
                </div>

                <div class="img-place" style="background-image: url('{{ $information->image_path }}');"></div>
            </section>
        @endif
